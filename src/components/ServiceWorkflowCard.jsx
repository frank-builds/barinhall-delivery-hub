  ...
  return (
    <li className="border border-gray-100 rounded-md overflow-hidden">
      ...
      >
        ...
        <span className="flex-shrink-0 flex items-center gap-2 text-xs text-gray-400">
...
function SimpleStepRow({ label, index }) {
  return (
    <li className="flex items-center gap-3 py-2 text-sm text-gray-600">
...
export function ServiceWorkflowCard({ service }) {
  ...
  return (
    <div className="border border-gray-200 rounded-lg bg-white">
      {/* Service header */}
      <button
        className="w-full flex justify-between items-center px-5 py-4 text-left hover:bg-gray-50 rounded-lg transition-colors"
        onClick={() => setOpen(o => !o)}
      >
      ...
      {open && (
        <div className="px-5 pb-4 border-t border-gray-100">
          {playbook ? (
            ...
            <>
              <ul className="space-y-0 divide-y divide-gray-50 pt-1">
